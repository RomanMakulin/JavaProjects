...
public class Controller {
    public void btnClick(){
        ...
        courseRepository.createCourse(new Course("Java junior", 30));
        courseRepository.createCourse(new Course("JDK", 20));
        courseRepository.createCourse(new Course("Java hibernate", 1));
