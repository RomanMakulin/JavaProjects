...
public class HomeNavigator implements Menu {
    ...
    public void menu() {
        ...
        switch (new inputMenuCommand().input()){
            case "1":
                new newAnimal().create(new Cat(new inputNameAnimal().input(), new inputCommandAnimal().input(), new inputDateBith().input()));
                break;
            case "2":
                new newAnimal().create(new Dog(new inputNameAnimal().input(), new inputCommandAnimal().input(), new inputDateBith().input()));
                break;
            case "3":
                new newAnimal().create(new Hamster(new inputNameAnimal().input(), new inputCommandAnimal().input(), new inputDateBith().input()));
                break;
            case "4":
