...
Результат: получено приложение, генерирующее: 
- необходимое кол-во студентов;
- учителя для закрепления за группой;
- саму учебную группу.
Реализован счетчик юзеров, для каждого учителя добавлена информация в поле, к какой группе он относится.